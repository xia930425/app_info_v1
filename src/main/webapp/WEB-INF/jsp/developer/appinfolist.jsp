...
<script src="${pageContext.request.contextPath }/statics/localjs/rollpage.js" charset="UTF-8"></script>
<script src="${pageContext.request.contextPath }/statics/localjs/appinfolist.js" charset="UTF-8"></script>