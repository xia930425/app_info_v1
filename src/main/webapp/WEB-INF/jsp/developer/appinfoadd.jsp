        ...
        <form class="form-horizontal form-label-left" action="appinfoaddsave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="file" class="form-control col-md-7 col-xs-12" name="attach"  required="required" id="attach"/>
            ${fileUploadError }
            </div>
          </div>
...
<script src="${pageContext.request.contextPath }/statics/localjs/appinfoadd.js" charset="UTF-8"></script>